...
from src.database.models.defects import get_defect_by_name
...
class DefectsSectionWidget(QWidget):
    ...
    def add_defect(self):
        ...
        if defect:
            ...
            item_widget.setStyleSheet(
                "#defectItem, #defectItem * { background-color: white; }"
                " #defectItem { border-bottom: 1px solid #bdc3c7; }"
            )
    ...
    def _resize_list(self):
        ...
        if count == 0:
            ...
            return
        total = sum(self.defects_list.sizeHintForRow(i) for i in range(count))
